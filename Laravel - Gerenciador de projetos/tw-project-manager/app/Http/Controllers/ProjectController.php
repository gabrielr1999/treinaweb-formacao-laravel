...
class ProjectController extends Controller
{
    ...
    public function update(ProjectRequest $request, Project $project)
    {
        ...
        return redirect()->route('projects.index')->with('mensagem', 'Projeto atualizado com sucesso!');
    }
    /**
    ...
    public function destroy(Project $project)
    {
        ...
        return redirect()->route('projects.index')->with('mensagem', 'Projeto excluido com sucesso!');
    }
}