...
class Aluno extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['aluno', 'nascimento', 'genero', 'turma_id'];
     ...
     * @var array
     */
    // protected $visible = ['id', 'aluno', 'genero', 'turma_id','aceito'];
    ...
    {
        return $this->belongsTo(Turma::class); //Um aluno pertence a uma turma
    }
